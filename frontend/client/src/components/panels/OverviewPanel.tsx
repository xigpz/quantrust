 ...
 */
import { useMarketOverview, useQuotes, useSectors, formatPrice, formatPercent, formatNumber, getChangeColor, getChangeBg } from '@/hooks/useMarketData';
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                {quotes?.slice(0, 50).map((q) => (
                  <tr key={q.symbol} className="border-b border-border/30 hover:bg-accent/50 transition-colors cursor-pointer">
